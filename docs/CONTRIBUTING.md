...
<p align="justify">
To contribute, you must follow our <!-- ProjectDependant --> <a href="https://github.com/GaryStriving/SDM-Website/blob/main/docs/CODE_OF_CONDUCT.md">Code of Conduct</a><!-- /ProjectDependant -->.
...
<!-- ProjectDependant -->
Contributions in SDM Website should relate to:
- Sonrisas del Mañana's content.
- Website performance.
- Best practices.
<!-- /ProjectDependant -->
